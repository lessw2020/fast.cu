  ...
  multiply(float *d, bf16 *sA, bf16 *sB,
    ...
    if constexpr (N == 256) {
      asm volatile(
          ...
          : "l"(desc_a), "l"(desc_b), "n"(int32_t(scale.D)),
            "n"(int32_t(scale.A)), "n"(int32_t(scale.B)), "n"(int32_t(trans.A)),
            "n"(int32_t(trans.B)));
      ...
      asm volatile("{\n"
                   ...
                   : "+f"(d[0][0]), "+f"(d[0][1]), "+f"(d[0][2]), "+f"(d[0][3]),
                     ...
                     "+f"(d[7][4]), "+f"(d[7][5]), "+f"(d[7][6]), "+f"(d[7][7])
                   : "l"(desc_a), "l"(desc_b), "n"(int32_t(scale.D)),
                     "n"(int32_t(scale.A)), "n"(int32_t(scale.B)),
                     "n"(int32_t(trans.A)), "n"(int32_t(trans.B)));
